...
<output>
{
  "prTitle": "Short past-tense descriptive summary of the PRD as a whole",
...
- `prTitle` must be a single line, under 70 characters, past-tense descriptive (NO conventional-commit prefixes), framed around the PRD as a whole.
- `prDescription` must:
