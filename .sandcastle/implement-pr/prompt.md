...
2. Make the code changes you decided on. Run `cargo fmt`, `cargo clippy -- -D warnings`, and `cargo test` before committing. Use past-tense descriptive commit messages (no conventional-commit prefixes).
