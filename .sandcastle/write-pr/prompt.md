...
<output>
{
  "prTitle": "Short past-tense descriptive summary",
  "prDescription": "## Summary\n\n- bullet 1\n- bullet 2\n\nCloses #{{ISSUE_NUMBER}}"
}
</output>

- `prTitle` must be a single line, under 70 characters, past-tense descriptive (NO conventional-commit prefixes like `feat:` or `fix:`).
